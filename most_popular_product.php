...
$sqle = "select p_id, sum(o_qty) as total_quantity From order_info group by p_id order by sum(o_qty) DESC ";

$result = mysqli_query($link, $sqle);
while ($row = mysqli_fetch_assoc($result)) {
    $d_id = $row['p_id'];
    $d_p_qty=$row['total_quantity'];
            ...
            <div class='feature_images_container'>
                <div class='feature1'>
                    ...
                    <div class='center'>$d_name <br>Price:RS $d_price<br>
                      Total Quantity Purchased=$d_p_qty
