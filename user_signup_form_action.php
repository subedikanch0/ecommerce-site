...
if (isset($_POST['submit'])) {
  ...
  if ($fname==NULL or $email==NULL or $mobile==NULL or $address==NULL or $p1==NULL or $p2==NULL) {
...
//    $password=crypt($p1,$salt);
  $query = "INSERT INTO user_info (u_name,u_num1,u_mail,u_add,u_password) values('$fname','$mobile','$email','$address','$p1')";
