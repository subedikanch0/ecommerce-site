...
<html>
<head>
    <title>Shop: Grocery & Staples</title>
...
$sqle = "SELECT p_id, p_name, p_price,p_image, p_des from p_info where p_category='grocery&staples'";
...
//        $d_qty = $row['p_qty'];
 ...
 <div class='rate' style=\"background: url('line.png') repeat-y; float: left; background-size: 75% auto; margin-left: 30px;\" class='rate'>
